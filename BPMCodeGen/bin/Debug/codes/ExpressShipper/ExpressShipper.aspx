            ...
            <tbody>
                <tr>
                    ...
                    <td style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none" rowspan="2" width="397" align="center">
                        <font size="6" face="宋体"><strong>寄件人信息
</strong></font> 
                    </td>
                ...
                <tr>
					...
					<!-- LF_ProgramDevCheck.SN -->
                        <aspxform:XTextBox id="XTextBox1" runat="server" BorderStyle="None" BorderColor="MintCream" BorderWidth="1px" width="100%" HiddenInput="False" XDataBind="ExpressShipper.SN
" Max="0" Min="0" ForeColor="Blue" TextAlign="Center" ValueToDisplayText Value ReadOnly="True">自动生成</aspxform:XTextBox>
        ...
        <table style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none" cellspacing="0" cellpadding="0" width="800" align="center" border="0">
			...
			<tr><td style="BORDER-TOP: medium none; BORDER-RIGHT: silver 1px solid; BORDER-BOTTOM: silver 1px solid; BORDER-LEFT: silver 1px solid" bgcolor="#e0e0e0" height="30"  colspan="8">
                       ...
                       <aspxform:XTextBox id="ExpressShippershipperStr" runat="server" BorderStyle="None" BorderColor="#DCDCDC" BorderWidth="1" width="100%"  XDataBind="ExpressShipper.shipperStr"></aspxform:XTextBox> </td><td style="BORDER-TOP: medium none; BORDER-RIGHT: silver 1px solid; BORDER-BOTTOM: silver 1px solid;text-align:center; BORDER-LEFT: silver 1px solid"  height="30" colspan="1">
                       ...
                       <aspxform:XTextBox id="ExpressShippershipperTelStr" runat="server" BorderStyle="None" BorderColor="#DCDCDC" BorderWidth="1" width="100%"  XDataBind="ExpressShipper.shipperTelStr"></aspxform:XTextBox> </td><td style="BORDER-TOP: medium none; BORDER-RIGHT: silver 1px solid; BORDER-BOTTOM: silver 1px solid;text-align:center; BORDER-LEFT: silver 1px solid"  height="30" colspan="1">
                       ...
                       <aspxform:XTextBox id="ExpressShippershipperPhoneStr" runat="server" BorderStyle="None" BorderColor="#DCDCDC" BorderWidth="1" width="100%"  XDataBind="ExpressShipper.shipperPhoneStr"></aspxform:XTextBox> </td><td style="BORDER-TOP: medium none; BORDER-RIGHT: silver 1px solid; BORDER-BOTTOM: silver 1px solid;text-align:center; BORDER-LEFT: silver 1px solid"  height="30" colspan="1">
                       ...
                       <aspxform:XTextBox id="ExpressShippershipperPostStr" runat="server" BorderStyle="None" BorderColor="#DCDCDC" BorderWidth="1" width="100%"  XDataBind="ExpressShipper.shipperPostStr"></aspxform:XTextBox> </td></tr><tr><td style="BORDER-TOP: medium none; BORDER-RIGHT: silver 1px solid; BORDER-BOTTOM: silver 1px solid;text-align:center; BORDER-LEFT: silver 1px solid"  height="30" colspan="1">
                       ...
                       <aspxform:XTextBox id="ExpressShippershipperUnit7Str" runat="server" BorderStyle="None" BorderColor="#DCDCDC" BorderWidth="1" width="100%"  XDataBind="ExpressShipper.shipperUnit7Str"></aspxform:XTextBox> </td></tr><tr><td style="BORDER-TOP: medium none; BORDER-RIGHT: silver 1px solid; BORDER-BOTTOM: silver 1px solid;text-align:center; BORDER-LEFT: silver 1px solid"  height="30" colspan="1">
                       ...
                       <aspxform:XTextBox id="ExpressShippershipperAdd7Str" runat="server" BorderStyle="None" BorderColor="#DCDCDC" BorderWidth="1" width="100%"  XDataBind="ExpressShipper.shipperAdd7Str"></aspxform:XTextBox> </td></tr>
            </tbody>
        </table>
