...
YZSoft.ExpressTab.OpenApplication = function(gridid,ID) {
    YZSoft.BPM.FormManager.OpenFormApplication('Express/发货申请', ID, 'Read', true, {
        title: '查看',
        width:830,
        height:505
    });
    ...
    constructor: function(config) {
        ...
        this.grid = new Ext.grid.GridPanel({
            ...
            columns: [
                ...
                { header: '申请人', dataIndex: 'proposerStr', width: 150, align: 'left' },{ header: '发货人', dataIndex: 'shipperStr', width: 150, align: 'left' },{ header: '收件人', dataIndex: 'toStr', width: 150, align: 'left' },{ header: '快递方式', dataIndex: 'expressTypeStr', id: 'extcol', align: 'left' }
            ],
            ...
            listeners: {
                ...
                rowdblclick: function(grid, rowIndex, e) {
                    YZSoft.BPM.FormManager.OpenFormApplication('Express/发货申请', this.store.getAt(rowIndex).data.TaskID, 'Read', true, {
                        title: '查看',
                        width:830,
                        height:505
                    });
        ...
        this.btnNew = new Ext.Button({
            ...
            scope: this,
            handler: function () {
                YZSoft.BPM.FormManager.OpenPostWindow('发货申请', true, {
                    title: '添加',
                    width: 830,
                    height: 505,
                    listeners: {
                ...
                //    YZSoft.BPM.FormManager.OpenFormApplication('Express/发货申请', '', 'New', true, {
            //    title: '添加',
            //    width:830,
            //    height:505,
            //    listeners: {
        ...
        EditRow: function(stamp) {
            YZSoft.BPM.FormManager.OpenFormApplication('Express/发货申请', stamp.TaskID, 'Edit', true, {
                title: '修改',
                 width:830,
                height:505,
                listeners: {
