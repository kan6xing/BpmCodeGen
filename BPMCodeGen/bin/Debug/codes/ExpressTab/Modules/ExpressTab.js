...
YZSoft.ExpressTab.OpenApplication = function(gridid,ID) {
    YZSoft.BPM.FormManager.OpenFormApplication('快递申请单', ID, 'Read', true, {
        title: '查看',
        width:830,
        height:505
    });
...
YZSoft.ExpressTab.NewsManagePanel = Ext.extend(Ext.Panel, {
    constructor: function(config) {
        ...
        this.grid = new Ext.grid.GridPanel({
            ...
            listeners: {
                ...
                rowdblclick: function(grid, rowIndex, e) {
                    YZSoft.BPM.FormManager.OpenFormApplication('快递申请单', this.store.getAt(rowIndex).data.TaskID, 'Read', true, {
                        title: '查看',
                        width:830,
                        height:505
                    });
        ...
        this.btnNew = new Ext.Button({
            ...
            scope: this,
            handler: function () {
                YZSoft.BPM.FormManager.OpenPostWindow('快递申请单', true, {
                    title: '添加',
                    width: 830,
                    height: 505,
                    listeners: {
                ...
                //    YZSoft.BPM.FormManager.OpenFormApplication('快递申请单', '', 'New', true, {
            //    title: '添加',
            //    width:830,
            //    height:505,
            //    listeners: {
        ...
        EditRow: function(stamp) {
            YZSoft.BPM.FormManager.OpenFormApplication('快递申请单', stamp.TaskID, 'Edit', true, {
                title: '修改',
                 width:830,
                height:505,
                listeners: {
